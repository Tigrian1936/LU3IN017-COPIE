                ...
                {options.map((option, index) => {
                    return (
                        <div key={index}>
                            ...
                            {options[index].type === SearchQueryType.DATE ? <input type="date" onChange={evt => setOptions([...options.slice(0, index), { type: options[index].type , value: {from : evt, up_to : evt.target.value}}, ...options.slice(index + 1, options.length)])}></input> : null}
